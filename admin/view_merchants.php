...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/view_merchants.css">
</head>
<body>
	...
	<div class="header">
	 ...
	 <?php 
	 		...
	 		$select = mysqli_query($db, "SELECT * FROM merchants ") or die (mysqli_error($db));
...
<h1 style="text-align: center; font-size: 50px;">Merchants</h1>
	 ...
	 <?php echo "<h3>Number of Merchants: <strong>". (mysqli_num_rows($select)). "</strong></h3>"?>
